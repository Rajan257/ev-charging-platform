...
import { LayoutDashboard, Globe, Users, TrendingUp, MapPin, Activity } from 'lucide-react'
  ...
  return (
    <div className="p-6 animate-fade-in">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {[
          { icon: MapPin, label: 'Total Stations', value: '127', color: '#00D1FF' },
          ...
          { icon: Activity, label: 'Energy (MTD)', value: '12,450 kWh', color: '#00D1FF' },
